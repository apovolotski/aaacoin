...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a AAAcoin address (e.g. %1)").arg(
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("aaacoin://", Qt::CaseInsensitive))
    {
        uri.replace(0, 10, "aaacoin:");
    }
...
{
    QString ret = QString("aaacoin:%1").arg(info.address);
    int paramCount = 0;
